...
def store_money():
    ...
    update_current_amount()  # Call the function again to ensure the current amount is updated immediately
...
def display_current():
    ...
    label_current = tk.Label(current_window, text=f"Current amount: {current_amount}")
